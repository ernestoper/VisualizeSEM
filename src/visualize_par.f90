...
! output information
! number of visualization plots
! it is generally equal to the number of processors but can be different
integer :: nplot
integer :: out_format,out_ncomp,out_res
...
! processor and plot infromation
integer :: nproc
integer :: proc_width
character(len=20) :: proc_form,proc_width_str
character(len=60) :: proc_head  
integer,dimension(:),allocatable :: plot_nnode,plot_nelmt ! Number of nodes and element in output plot 
integer,allocatable,dimension(:,:) :: plot_proc_list ! Procesor list in ouput plot
integer,allocatable,dimension(:) :: plot_nproc ! Number of input procesors in output plot
