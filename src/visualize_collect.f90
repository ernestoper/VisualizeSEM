...
! counts total number of points and elements for external meshes in given plot list
...
! loops over all plots (process partitions)
node_count = 0
elmt_count = 0
...
do i_proc = 1, nproc
  ...
  ! gets number of elements and points for this plot
